...
public class AdapterSearch extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterSearch(Context context, List<DataFish> data){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        myHolder.texttitle.setText(current.fishName);

        Picasso.with(context) //Context
                .load(current.fishImage) //URL/FILE
                .into(myHolder.imview);//an ImageView Object to show the loaded image;
//
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        public MyHolder(final View itemView) {
            ...
            imview = (ImageView) itemView.findViewById(R.id.imview);
